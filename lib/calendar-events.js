...
// calendars (Fed/ECB/BoE meeting calendars, BLS release schedules — NFP is
// NOT first-Friday-rule-derived; BLS shifts around holidays). Re-check each
// series against its source before the public launch, and whenever a
// series' institution republishes its calendar. Last full verification
// against official sources: 2026-06-12.
//
...
const EVENT_SERIES = [
  {
    ...
    timeUtc: '12:30',
    affected: USD_MAJORS,
    // Usually the first Friday of the month, but NOT rule-determined — BLS
    // moves around holidays: the June 2026 report releases THURSDAY Jul 2
    // because Fri Jul 3 is the observed Independence Day holiday. Always use
    // the published BLS schedule, never derive from the first-Friday rule.
    source: 'BLS Employment Situation release schedule — verified against official calendar 2026-06-12',
    dates: ['2026-07-02', '2026-08-07', '2026-09-04', '2026-10-02', '2026-11-06', '2026-12-04'],
  },
  {
    id: 'us-cpi',
    ...
    timeUtc: '12:30',
    affected: USD_MAJORS,
    source: 'BLS CPI release schedule — verified against official calendar 2026-06-12',
  ...
  },
  {
    ...
    timeUtc: '18:00',
    affected: USD_MAJORS,
    source: 'Federal Reserve 2026 FOMC meeting calendar (decision day of each two-day meeting) — verified against official calendar 2026-06-12',
  ...
  },
  {
    ...
    source: 'ECB Governing Council monetary-policy meeting calendar 2026 (announcement 14:15 CEST) — verified against official calendar 2026-06-12',
  ...
  },
  {
    ...
    source: 'Bank of England MPC meeting calendar 2026 — verified against official calendar 2026-06-12',
