            ...
            <div style={{ background: '#111e2e', border: '0.5px solid #1a2e42', borderRadius: '12px', padding: '20px', marginBottom: '20px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px', marginBottom: '12px' }}>
                {[
                  ...
                  { label: 'Entry Price', value: article.entry_price ? parseFloat(article.entry_price).toFixed(5) : '—', color: '#60c8d4' },
                  { label: 'R:R Ratio', value: article.rr_ratio ? `1:${parseFloat(article.rr_ratio).toFixed(2)}` : '—', color: '#60c8d4' },
                  { label: 'Stop Loss', value: article.stop_loss ? parseFloat(article.stop_loss).toFixed(5) : '—', color: '#e05555' },
                  { label: 'Take Profit', value: article.take_profit ? parseFloat(article.take_profit).toFixed(5) : '—', color: '#1D9E75' },
